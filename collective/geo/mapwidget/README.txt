...
Overview
--------
collective.geo.mapwidget provides a graphical user interface to store settings for collective.geo applications.
...
we log in and verify the functionality of collective.geo.mapwidget control panel form;
